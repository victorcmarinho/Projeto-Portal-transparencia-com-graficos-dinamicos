...
?>
    ...
    <head>
        ...
        <title>Administração da despesa</title>
        <!-- Bootstrap -->
                                    ...
                                    <div class="tab-content">
                                        <div id="table">
                                            <table id="TabelaAD" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php if($result=$dbo->query("SELECT * FROM `despesa` limit 50")){ ?>
                                                    <?php if($result){ ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $row['numero_empenho_numero']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['pessoas_cpfcnpj']; ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php echo $row['programa_idprograma']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['acao_idacao']; ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php echo $row['modalidade_idmodalidade']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['elemento_idelemento']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['historico']; ?>
                                                        </td>
                                                        <td>
                                                            <a href="editarD.php?id=<?php echo $row['iddespesa']; ?>">
                                                                <button type="button" class="btn btn-warning">Editar</button>
                                                            </a>
                                                            <form action="#" method="post">
                                                                <button type="submit" class="btn btn-danger">Excluir</button>
                                                                <input type="hidden" name="excluir" value="<?php echo $row['iddespesa']; ?>">
                                                            </form>
                                                        </td>
