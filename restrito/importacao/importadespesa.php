                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-suitcase"></i>Despesas</a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="cadastrodespesa.html">Importação de despesa</a></li>
                                        <li><a href="#">Dashboard3</a></li>
                                    </ul>
                                </li>
                                <li><a href="../licitacaoAd.html"><i class="fa fa-suitcase"></i>Licitação</a></li>
                                <li><a href="../cadastro/cadastro.html"><i class="fa fa-group"></i>Cadastro de usuários</a></li>
                                <li><a href="../cadastro/formularioCadastro.js"><i class="fa fa-list-alt"></i>Lista de usuários</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
